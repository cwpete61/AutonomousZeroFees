...
const PIPELINE_STAGES = [
  ...
  { id: 'demo_sent', label: 'Audit Sent', color: '#f97316' },
...
const INITIAL_AGENTS = [
  ...
  { name: 'Profit Audit', status: 'idle', lastRun: 'Never', processed: 0 },
...
const SYSTEM_CATEGORIES = {
  ...
  "Kitchen remodeler": ["kitchen renovation", "cabinet installation", "countertop installation", "kitchen efficiency setup", "appliance installation"],
